...
<ul
	...
	<li class="nav-item">
		...
		aria-expanded="true" aria-controls="collapsePages"> <i
			class="fas fa-fw fa-folder"></i> <span>Gestión de Usuario</span>
		</a>
		<div id="collapsePages" class="collapse"
			aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">Usuario:</h6>
				<a class="collapse-item" href="Usuario.jsp">Lista de Usuarios</a> 
				<a class="collapse-item" href="rol.jsp">Lista de Roles</a> 
				<a
